    ...
    return(
        <>
            ...
            <View style={{ padding: 10, alignContent: "center", alignSelf: "center", marginTop: 12, height: 150, justifyContent: "center" }}>
                ...
                <Text style={{ textAlign: "center", fontFamily: "mons-e", color: colors ? colors : Colors.primaryColor }} >Avec <Text style={{fontFamily: "nab"}}>{appname}</Text>, ne mourez plus de faim </Text>
